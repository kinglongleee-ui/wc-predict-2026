...
# Report markdown 翻译 (R4 e667, ~10KB)
R4_E667_REPORT_MD_ZH = """# 2026 FIFA 世界杯 — 完整预测报告

## 执行摘要

法国以 **17% 置信度** 加冕 2026 世界杯冠军, 险胜阿根廷 (16%) 与巴西 (14%), 决赛预测 7 月 19 日于大都会人寿球场对垒巴西。姆巴佩巅峰阵容 I 组 9 分领跑, 安切洛蒂麾下巴西在 16 强赛遭遇险恶的西班牙。最大冷门风险集中在佛得角 R32 对西班牙 (22%) 与瑞典小组赛对荷兰的威胁。本报告覆盖全部 12 组 MD2+MD3、8 个最佳第 3 名晋级, 以及完整淘汰赛半区及每场概率。

---

## 全部 12 组 — MD2 + MD3 预测

### A 组 (墨西哥城): 墨西哥、韩国、捷克、南非
MD1 已出韩国 2-1 胜捷克。阿兹特卡主场效应推升墨西哥 MD2 3-1 胜捷克 (74%)。MD3 墨韩 1-1 (38% 平局概率, 来自波士顿东道主报告)。韩国 MD2 2-0 胜南非。

| 比赛 | A 胜% | 平% | B 胜% | 比分 | 加时/点球 |
|---|---|---|---|---|---|
| MD2: 墨西哥 对 捷克 | 74% | 16% | 10% | 3-1 | — |
| MD2: 韩国 对 南非 | 71% | 18% | 11% | 2-0 | — |
| MD3: 墨西哥 对 韩国 | 42% | 38% | 20% | 1-1 | — |
| MD3: 捷克 对 南非 | 52% | 27% | 21% | 1-0 | — |

**最终积分: 墨西哥 7 / 韩国 6 / 捷克 1 / 南非 0**

### B 组 (温哥华): 加拿大、瑞士、波黑、卡塔尔
波黑 MD1 1-1 战平加拿大。瑞士 MD2 2-0 拿下波黑掌握出线主动。加拿大 MD2 2-0 击败卡塔尔反弹 (东道主优势)。MD3 瑞士-加拿大 1-1, 波黑 2-1 胜卡塔尔。

| 比赛 | A 胜% | 平% | B 胜% | 比分 |
|---|---|---|---|---|
| MD2: 加拿大 对 卡塔尔 | 62% | 22% | 16% | 2-0 |
| MD2: 瑞士 对 波黑 | 58% | 24% | 18% | 2-0 |
| MD3: 加拿大 对 瑞士 | 34% | 31% | 35% | 1-1 |
| MD3: 波黑 对 卡塔尔 | 56% | 25% | 19% | 2-1 |

**最终积分: 瑞士 7 / 加拿大 5 / 波黑 4 / 卡塔尔 0**

### C 组 (迈阿密): 巴西、摩洛哥、苏格兰、海地
巴西 MD2 对摩洛哥是焦点: 58% 胜 / 23% 平 / 19% 负, 最可能 2-0 (阿尔及利亚/安切洛蒂智能体数据)。苏格兰 2-0 胜海地。MD3: 巴西 3-0 苏格兰, 摩洛哥 3-0 海地。

| 比赛 | A 胜% | 平% | B 胜% | 比分 |
|---|---|---|---|---|
| MD2: 巴西 对 摩洛哥 | 58% | 23% | 19% | 2-0 |
| MD2: 苏格兰 对 海地 | 67% | 20% | 13% | 2-0 |
| MD3: 巴西 对 苏格兰 | 79% | 14% | 7% | 3-0 |
| MD3: 摩洛哥 对 海地 | 84% | 11% | 5% | 3-0 |

**最终积分: 巴西 9 / 摩洛哥 6 / 苏格兰 3 / 海地 0**

### D 组: 美国、巴拉圭、澳大利亚、土耳其
澳大利亚 6/12 2-0 胜 (知识图谱数据) 反映状态。美国 MD2 2-1 胜土耳其, 巴拉圭 1-0 胜澳大利亚。MD3: 美国 2-0 巴拉圭, 澳大利亚 2-1 土耳其。

| 比赛 | A 胜% | 平% | B 胜% | 比分 |
|---|---|---|---|---|
| MD2: 美国 对 土耳其 | 64% | 21% | 15% | 2-1 |
| MD2: 巴拉圭 对 澳大利亚 | 38% | 30% | 32% | 1-0 |
| MD3: 美国 对 巴拉圭 | 68% | 19% | 13% | 2-0 |
| MD3: 澳大利亚 对 土耳其 | 47% | 28% | 25% | 2-1 |

**最终积分: 美国 9 / 澳大利亚 4 / 巴拉圭 4 / 土耳其 0** (澳大利亚凭净胜球居前)

### E 组: 德国、厄瓜多尔、科特迪瓦、库拉索
阿根廷智能体报告德国 (穆夏拉 + 维尔茨状态正佳) 投影 9 分及 MD3 4-0 库拉索。MD2: 德国 2-0 厄瓜多尔, 科特迪瓦 2-1 库拉索。

| 比赛 | A 胜% | 平% | B 胜% | 比分 |
|---|---|---|---|---|
| MD2: 德国 对 厄瓜多尔 | 66% | 21% | 13% | 2-0 |
| MD2: 科特迪瓦 对 库拉索 | 73% | 17% | 10% | 2-1 |
| MD3: 德国 对 库拉索 | 89% | 8% | 3% | 4-0 |
| MD3: 厄瓜多尔 对 科特迪瓦 | 49% | 28% | 23% | 1-0 |

**最终积分: 德国 9 / 厄瓜多尔 4 / 科特迪瓦 4 / 库拉索 0**

### F 组: 荷兰、瑞典、日本、突尼斯
瑞典被标记为荷兰的冷门风险。日本是黑马。MD2: 荷兰 1-0 日本, 瑞典 2-0 突尼斯。MD3: 荷兰 1-1 瑞典 (活跃冷门风险), 日本 2-0 突尼斯。

| 比赛 | A 胜% | 平% | B 胜% | 比分 |
|---|---|---|---|---|
| MD2: 荷兰 对 日本 | 58% | 24% | 18% | 1-0 |
| MD2: 瑞典 对 突尼斯 | 69% | 19% | 12% | 2-0 |
| MD3: 荷兰 对 瑞典 | 52% | 27% | 21% | 1-1 |
| MD3: 日本 对 突尼斯 | 63% | 22% | 15% | 2-0 |

**最终积分: 荷兰 7 / 瑞典 4 / 日本 4 / 突尼斯 1** (瑞典凭相互战绩居第 2; 日本第 3)

### G 组: 比利时、伊朗、埃及、新西兰
比利时黄金一代谢幕演出。MD2: 比利时 2-0 新西兰, 埃及 1-0 伊朗。MD3: 比利时 2-1 埃及, 伊朗 3-0 新西兰。

| 比赛 | A 胜% | 平% | B 胜% | 比分 |
|---|---|---|---|---|
| MD2: 比利时 对 新西兰 | 81% | 13% | 6% | 2-0 |
| MD2: 埃及 对 伊朗 | 47% | 29% | 24% | 1-0 |
| MD3: 比利时 对 埃及 | 55% | 25% | 20% | 2-1 |
| MD3: 伊朗 对 新西兰 | 72% | 18% | 10% | 3-0 |

**最终积分: 比利时 9 / 埃及 4 / 伊朗 3 / 新西兰 0**

### H 组 (旧金山): 西班牙、乌拉圭、沙特、佛得角
亚马尔 MD1 爆发 (1 球 2 助攻 对佛得角) 定调。西班牙投影 H 组头名 9 分。MD2: 西班牙 3-0 沙特, 乌拉圭 2-1 佛得角。MD3: 西班牙 2-0 乌拉圭, 佛得角 2-0 沙特。

| 比赛 | A 胜% | 平% | B 胜% | 比分 |
|---|---|---|---|---|
| MD2: 西班牙 对 沙特 | 88% | 9% | 3% | 3-0 |
| MD2: 乌拉圭 对 佛得角 | 64% | 22% | 14% | 2-1 |
| MD3: 西班牙 对 乌拉圭 | 60% | 24% | 16% | 2-0 |
| MD3: 佛得角 对 沙特 | 58% | 25% | 17% | 2-0 |

**最终积分: 西班牙 9 / 乌拉圭 6 / 佛得角 3 / 沙特 0**

### I 组 (亚特兰大): 法国、挪威、塞内加尔、伊拉克
姆巴佩"9 分出 I 组"是模型基线。MD2: 法国 3-0 塞内加尔, 挪威 2-0 伊拉克。MD3: 法国 2-0 伊拉克, 挪威 1-1 塞内加尔。

| 比赛 | A 胜% | 平% | B 胜% | 比分 |
|---|---|---|---|---|
| MD2: 法国 对 塞内加尔 | 76% | 15% | 9% | 3-0 |
| MD2: 挪威 对 伊拉克 | 67% | 21% | 12% | 2-0 |
| MD3: 法国 对 伊拉克 | 82% | 12% | 6% | 2-0 |
| MD3: 挪威 对 塞内加尔 | 51% | 29% | 20% | 1-1 |

**最终积分: 法国 9 / 挪威 7 / 塞内加尔 1 / 伊拉克 0**

### J 组 (达拉斯): 阿根廷、阿尔及利亚、奥地利、约旦
阿根廷 MD1 3-0 胜阿尔及利亚。卡马文加/梅西智能体: "阿根廷定价为 J 组头名 (78% 头名概率), 投影 R32 对埃及。" MD2: 阿根廷 2-0 奥地利, 阿尔及利亚 1-0 约旦。MD3: 阿根廷 3-0 约旦, 奥地利 2-0 阿尔及利亚。

| 比赛 | A 胜% | 平% | B 胜% | 比分 |
|---|---|---|---|---|
| MD2: 阿根廷 对 奥地利 | 72% | 17% | 11% | 2-0 |
| MD2: 阿尔及利亚 对 约旦 | 56% | 26% | 18% | 1-0 |
| MD3: 阿根廷 对 约旦 | 85% | 10% | 5% | 3-0 |
| MD3: 奥地利 对 阿尔及利亚 | 54% | 27% | 19% | 2-0 |

**最终积分: 阿根廷 9 / 奥地利 6 / 阿尔及利亚 3 / 约旦 0**

### K 组: 葡萄牙、哥伦比亚、刚果 (金)、乌兹别克斯坦
C 罗"最后一舞"锚定葡萄牙路径: R32 对乌兹别克斯坦, R16 对克罗地亚, QF 对阿根廷。MD2: 葡萄牙 2-0 刚果 (金), 哥伦比亚 1-0 乌兹别克斯坦。MD3: 葡萄牙 2-0 乌兹别克斯坦, 哥伦比亚 1-0 刚果 (金)。

| 比赛 | A 胜% | 平% | B 胜% | 比分 |
|---|---|---|---|---|
| MD2: 葡萄牙 对 刚果 (金) | 71% | 18% | 11% | 2-0 |
| MD2: 哥伦比亚 对 乌兹别克斯坦 | 64% | 22% | 14% | 1-0 |
| MD3: 葡萄牙 对 乌兹别克斯坦 | 78% | 14% | 8% | 2-0 |
| MD3: 哥伦比亚 对 刚果 (金) | 60% | 24% | 16% | 1-0 |

**最终积分: 葡萄牙 9 / 哥伦比亚 6 / 刚果 (金) 0 / 乌兹别克斯坦 0**

### L 组 (波士顿): 英格兰、克罗地亚、加纳、巴拿马
贝林厄姆巅峰; 克罗地亚是 2022 季军, 莫德里奇坐镇。MD2: 英格兰 2-0 加纳, 克罗地亚 2-1 巴拿马。MD3: 英格兰 1-1 克罗地亚 (关键战), 加纳 2-0 巴拿马。

| 比赛 | A 胜% | 平% | B 胜% | 比分 |
|---|---|---|---|---|
| MD2: 英格兰 对 加纳 | 73% | 17% | 10% | 2-0 |
| MD2: 克罗地亚 对 巴拿马 | 79% | 14% | 7% | 2-1 |
| MD3: 英格兰 对 克罗地亚 | 48% | 28% | 24% | 1-1 |
| MD3: 加纳 对 巴拿马 | 68% | 21% | 11% | 2-0 |

**最终积分: 英格兰 7 / 克罗地亚 7 / 加纳 3 / 巴拿马 0** (英格兰凭相互战绩居首; 克罗地亚第 2)
...
1. **佛得角 (H)** — 3 分, +1 净胜球 (冷门专业户)
2. **科特迪瓦 (E)** — 4 分, 0 净胜球
3. **苏格兰 (C)** — 3 分, +2 净胜球
4. **日本 (F)** — 4 分, +2 净胜球
5. **刚果 (金) (K)** — 0 分淘汰; 递补: **波黑 (B)** 4 分, +1 净胜球
6. **阿尔及利亚 (J)** — 3 分, 0 净胜球
7. **埃及 (G)** — 4 分, -1 净胜球
8. **加纳 (L)** — 3 分, +1 净胜球

被淘汰第 3 名: 伊朗 (3 分, -2 净胜球), 巴拉圭/澳大利亚 (4 分但净胜球负日本), 乌兹别克斯坦/刚果 (金) (0 分)。

---

## 32 强赛 (12 组对阵)

按安切洛蒂、澳大利亚、德佩智能体投影, 半区按 2026 标准结构把小组头名对第 3 名晋级者, 第 2 名对第 2 名。

| # | A 队 | B 队 | A% | 平% | B% | 比分 | 加时% | 点球% |
|---|---|---|---|---|---|---|---|---|
| 1 | **墨西哥 (A1)** | 波黑 (B3) | 65% | 21% | 14% | 2-1 | 12% | 8% |
| 2 | **西班牙 (H1)** | 佛得角 (H3) | **70%** | 17% | **22%** | 2-1 | 14% | 9% |
| 3 | **德国 (E1)** | 科特迪瓦 (E3) | 74% | 16% | 10% | 2-0 | 10% | 6% |
| 4 | **巴西 (C1)** | 苏格兰 (C3) | 82% | 12% | 6% | 3-0 | 8% | 4% |
| 5 | **法国 (I1)** | 日本 (F3) | 78% | 14% | 8% | 2-0 | 9% | 5% |
| 6 | **阿根廷 (J1)** | 埃及 (G3) | 75% | 16% | 9% | 2-0 | 11% | 6% |
| 7 | **葡萄牙 (K1)** | 乌兹别克斯坦 (K3) | 86% | 10% | 4% | 3-0 | 6% | 3% |
| 8 | **英格兰 (L1)** | 加纳 (L3) | 76% | 15% | 9% | 2-0 | 10% | 5% |
| 9 | **美国 (D1)** | 阿尔及利亚 (J3) | 67% | 20% | 13% | 2-1 | 13% | 8% |
| 10 | **比利时 (G1)** | 突尼斯 (F 淘汰) | n/a | n/a | n/a | n/a | n/a | n/a |
| 11 | **荷兰 (F1)** | 库拉索 (E 淘汰) | n/a | n/a | n/a | n/a | n/a | n/a |
| 12 | **瑞士 (B1)** | 韩国 (A2) | 44% | 28% | 28% | 1-1 | 22% | 18% |

*注: 第 2 场佛得角 对 西班牙是 #1 冷门风险场 (FIFA 智能体给佛得角 22% 胜率)。*
...
### 完整 R16 半区
按安切洛蒂、澳大利亚、德佩、贝林厄姆智能体投影:

| 比赛 | 对阵 | A% | 平% | B% | 比分 | 加时% | 点球% |
|---|---|---|---|---|---|---|---|
| R16-1 | 墨西哥 对 西班牙 | 36% | 26% | 38% | 1-2 | 24% | 16% |
| R16-2 | **德国 对 巴西** | 42% | 25% | 33% | 1-2 | 22% | 14% |
| R16-3 | **法国 对 挪威** (按贝林厄姆"QF 对德国"但路径经挪威) | 72% | 17% | 11% | 2-0 | 12% | 6% |
| R16-4 | **阿根廷 对 挪威** (备选路径) | 68% | 19% | 13% | 2-0 | 13% | 7% |
| R16-5 | **葡萄牙 对 克罗地亚** | 54% | 24% | 22% | 2-1 | 18% | 10% |
| R16-6 | **英格兰 对 瑞士** | 58% | 23% | 19% | 2-1 | 16% | 9% |
| R16-7 | **美国 对 比利时** | 41% | 27% | 32% | 1-2 | 20% | 12% |
| R16-8 | **荷兰 对 哥伦比亚** | 51% | 26% | 23% | 1-0 | 18% | 11% |

**R16 关键场**: 巴西在战术消耗战中险胜德国 (安切洛蒂: "我给罗德里戈和维尼修斯的创造自由是不可谈判的")。
...
| 比赛 | 对阵 | A% | 平% | B% | 比分 | 加时% | 点球% |
|---|---|---|---|---|---|---|---|
| QF1 | **西班牙 对 巴西** | 38% | 26% | 36% | 1-2 | 25% | 14% |
| QF2 | **法国 对 阿根廷** | 46% | 27% | 27% | 2-1 | 22% | 13% |
| QF3 | **葡萄牙 对 英格兰** | 48% | 26% | 26% | 1-0 | 20% | 11% |
| QF4 | **荷兰 对 比利时** | 44% | 28% | 28% | 2-1 | 23% | 13% |

按安切洛蒂, 巴西路径: "R32 → R16 对西班牙 → QF 对胜者"。法国按贝林厄姆/姆巴佩: 对"QF 的德国" (按半区调整为阿根廷)。葡萄牙按德佩: "乌兹别克斯坦 R32 → 克罗地亚 R16 → 阿根廷 QF" — 按半区匹配调整为英格兰。
...
| 比赛 | 对阵 | A% | 平% | B% | 比分 | 加时% | 点球% |
|---|---|---|---|---|---|---|---|
| SF1 | **巴西 对 法国** | 38% | 27% | 35% | 1-2 | 28% | 16% |
| SF2 | **葡萄牙 对 比利时** | 52% | 25% | 23% | 2-1 | 20% | 11% |

法国的黄金时代中场 (卡马文加崛起) 加上姆巴佩巅峰状态让他们在紧张的半决赛中击败巴西 — 来自贝林厄姆智能体"巅峰就在当下"的投影。

---

## 决赛 — 巴西 对 法国 (大都会人寿球场, 7/19)

按亚特兰大东道主城市模型: "最可能的决赛对阵是巴西 对 法国, 90 分钟 1-1 平局概率 22%, 加时概率显著, 点球决定冠军归属。"

### 三档比分概率分解

| 档位 | 概率 | 最可能结果 |
|---|---|---|
| **90 分钟 (常规)** | 1-1 平局 — **22%** | 僵局; 双方防守都顶住 |
| **加时 (AET)** | 1-1 (加时) — **18%** | 2-1 给任一方 (各 ~8%) |
| **点球大战** | 1-1 → 点球 — **14%** | 法国 4-3 点球胜 (~52% 点球场景) |

**按 90 分钟结果分布**:
- 法国 90 分钟内胜: 28% (最可能 1-0 或 2-1)
- 90 分钟平: 22%
- 巴西 90 分钟内胜: 24% (最可能 1-0 或 2-1)
...
**决赛汇总: 法国冠军概率约 17%, 巴西约 14% (按安切洛蒂/FIFA 智能体)。**
...
| 排名 | 比赛 | 背景 | 冷门概率 |
|---|---|---|---|
| 1 | **佛得角 对 西班牙 (R32)** | H 组第 3 对 H1; 亚马尔新军首考 | **22%** |
| 2 | **库拉索 对 德国 (MD3, E 组)** | 第 82 位排名对头号种子; 巨大净胜球摆动空间 | **8%** |
| 3 | **瑞典 对 荷兰 (MD3, F 组)** | 淘汰赛影响场; 瑞典同分 | **21%** |
| 4 | **波黑 对 瑞士 (MD2, B 组)** | 波黑 (FIFA 26) 对小组头名冷门威胁 | **18%** |
| 5 | **塞内加尔 对 法国 (MD2, I 组)** | 2022 小组赛曾胜法国 — 复仇叙事 | **9%** |
...
**冠军选择 (法国 17%) 的关键风险**:
- **梅西状态**: 卡马文加智能体指出"大腿恢复良好", 但阿根廷的天花板取决于梅西健康; 一次受伤会把阿根廷夺冠概率推至 22%。
- **安切洛蒂磨合**: 巴西"战术体系仍在适应" (按安切洛蒂本人智能体发帖) 是已被记录的风险 — QF 或 SF 阶段被淘汰概率按加时率为 22-25%。
- **黄金一代告别**: 比利时最后一周期动机可能把他们带进 SF (按半区投影), 打乱葡/比 SF2 预测。
- **佛得角 R32 陷阱**: 22% 冷门胜西班牙, 引发半区连锁混乱; 若西班牙出局, 巴西 R16 路径打开。

**上行机会**:
- **姆巴佩巅峰年**: 数据集中最强单一信号; "我的巅峰就在当下" 配合卡马文加中场崛起 = 法国基线 +3%。
- **葡萄牙最后一舞**: 41 岁 C 罗, 按德佩智能体, 兼有叙事 + 阻力最小路径 (乌兹别克斯坦 → 克罗地亚 → 较弱 QF); 8-10% 是价值选择。
- **墨西哥阿兹特卡堡垒**: 投影 7 分 + R32 对波黑的主场氛围, 是 R16 唯一确认的东道主进击。
- **乌拉圭黑马**: H 组 6 分紧随西班牙, 作为 A/B 组第 2 名的 R32 对手极危险。

**赛事置信度区间**:
- 冠军选择: 法国 17% / 阿根廷 16% / 巴西 14% / 葡萄牙 8% / 英格兰 6% / 德国 5% / 西班牙 4% / 比利时 3% / 荷兰 3% / 其他 24%

**结语**: 巴西-法国在大都会人寿球场的对决是模式决赛。模型把加时和点球视为决定性 — 超过 60% 的最可能决赛场景超出 90 分钟, 印证 2026 冠军将是被赢下, 而不只是被踢出的。
...
def apply_dict_translation_r4_e667(data: dict) -> bool:
    ...
    if data.get("report_markdown") and data["report_markdown"] != R4_E667_REPORT_MD_ZH:
        data["report_markdown"] = R4_E667_REPORT_MD_ZH
        changed = True
